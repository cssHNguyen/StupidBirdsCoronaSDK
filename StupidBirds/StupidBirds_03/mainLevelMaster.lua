...
local function getLevelOne ()
	local levelTable = {
		...
		{Image = display.newImage ("Assets/PhysicsOBJ/triRockLeftBlock01.png", 610, 270), Type = "StandingPhysics"},
		{Image = display.newImage ("Assets/PhysicsOBJ/triRockRightBlock01.png", 892, 270), Type = "StandingPhysics"},
