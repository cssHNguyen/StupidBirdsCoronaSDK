...
local function getLevelThree ()
	local levelTable = {
		{Image = display.newImage ("Assets/PhysicsOBJ/branch01.png", 100, 245), Type = "NonPhysics", Strength = "Strong"},
		{Image = display.newImage ("Assets/PhysicsOBJ/rockPlank01.png", 840, 228), Type = "StaticPhysics", Strength = "XStrong"},
		{Image = display.newImage ("Assets/PhysicsOBJ/rockPlank01.png", 660, 228), Type = "StaticPhysics", Strength = "XStrong"},
		{Image = display.newImage ("Assets/PhysicsOBJ/rockPlank01.png", 636, 228), Type = "StaticPhysics", Strength = "XStrong"},
		{Image = display.newImage ("Assets/PhysicsOBJ/rockPlank01.png", 614, 228), Type = "StaticPhysics", Strength = "XStrong"},
		{Image = display.newImage ("Assets/PhysicsOBJ/woodPlank01.png", 750, 130), Type = "StandingPhysics", Strength = "Weak"},
		{Image = display.newImage ("Assets/PhysicsOBJ/rockBlock01.png", 710, 290), Type = "StaticPhysics", Strength = "Normal"},
		{Image = display.newImage ("Assets/PhysicsOBJ/rockBlock01.png", 790, 290), Type = "StaticPhysics", Strength = "Normal"},
		{Image = display.newImage ("Assets/PhysicsOBJ/triRockLeftBlock01.png", 580, 290), Type = "StaticPhysics", Strength = "Strong"},
		{Image = display.newImage ("Assets/PhysicsOBJ/triRockRightBlock01.png", 872, 290), Type = "StaticPhysics", Strength = "Strong"}
	}
	return levelTable
end
...
local function getLevelThreeAnimal ()
	local levelAnimalTable = {
		{Animal = pigGenerator.newPig ("Large", 755, 225), Type = "StandingPhysics"},
	}
	return levelAnimalTable
